...
public class CeilingTorchClient {
	...
	public static void onRegisterParticleProviders(RegisterParticleProvidersEvent event) {
		if (!CeilingTorch.isModCompatActive("ms")) {
			event.register(CeilingTorch.MO_SHIZ_DYED_CEILING_FLAME.get(), FlameParticle.Provider::new);
			event.register(CeilingTorch.MO_SHIZ_DYED_CEILING_SMOKE.get(), SmokeParticle.Provider::new);
		}
	}
}
