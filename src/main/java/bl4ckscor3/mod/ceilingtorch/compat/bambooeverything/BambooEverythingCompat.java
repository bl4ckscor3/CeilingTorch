...
public class BambooEverythingCompat implements ICeilingTorchCompat {
	//@formatter:off
	public static final RegistryObject<CeilingTorchBlock> CEILING_BAMBOO_TORCH = CeilingTorch.BLOCKS.register("bambooeverything_bamboo_torch", () -> new CeilingTorchBlock(Block.Properties.of()
			.noCollission()
			.instabreak()
			.lightLevel(state -> 14)
	...
	public static final RegistryObject<CeilingTorchBlock> DRY_CEILING_BAMBOO_TORCH = CeilingTorch.BLOCKS.register("bambooeverything_dry_bamboo_torch", () -> new CeilingTorchBlock(Block.Properties.of()
			.noCollission()
			.instabreak()
			.lightLevel(state -> 14)
			.sound(SoundType.BAMBOO)
