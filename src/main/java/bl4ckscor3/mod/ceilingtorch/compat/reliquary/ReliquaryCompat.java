...
public class ReliquaryCompat implements ICeilingTorchCompat {
	public static final DeferredBlock<InterdictionCeilingTorchBlock> INTERDICTION_CEILING_TORCH = CeilingTorch.BLOCKS.registerBlock("reliquary_interdiction_torch", InterdictionCeilingTorchBlock::new);
