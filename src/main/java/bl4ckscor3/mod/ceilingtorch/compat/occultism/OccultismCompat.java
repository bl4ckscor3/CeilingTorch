...
public class OccultismCompat implements ICeilingTorchCompat {
	//@formatter:off
	public static final DeferredBlock<CeilingTorchBlock> CEILING_SPIRIT_TORCH = CeilingTorch.BLOCKS.register("occultism_spirit_torch", () -> new CeilingTorchBlock(BlockBehaviour.Properties.of()
			.noCollission()
			.instabreak()
			.lightLevel(state -> 10)
