...
public class SilentGearCompat implements ICeilingTorchCompat
{
	...
	{
		event.getRegistry().register(stoneCeilingTorch = new CeilingTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0.0F).setLightLevel(state -> 14).sound(SoundType.STONE), ParticleTypes.FLAME) {
			@Override
