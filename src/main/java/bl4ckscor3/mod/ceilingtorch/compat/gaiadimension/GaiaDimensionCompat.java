...
public class GaiaDimensionCompat implements ICeilingTorchCompat {
	public static final DeferredBlock<Block> PYRITE_CEILING_TORCH = CeilingTorch.BLOCKS.registerBlock("gaiadimension_pyrite_torch", p -> new CeilingTorchBlock(p, null, ModBlocks.pyrite_torch) {
		@Override
