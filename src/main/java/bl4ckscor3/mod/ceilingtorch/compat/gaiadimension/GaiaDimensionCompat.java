...
public class GaiaDimensionCompat implements ICeilingTorchCompat {
	public static final DeferredBlock<Block> PYRITE_CEILING_TORCH = CeilingTorch.BLOCKS.register("gaiadimension_pyrite_torch", () -> new CeilingTorchBlock(PropertiesHandler.torchProps(), null, ModBlocks.pyrite_torch) {
		@Override
