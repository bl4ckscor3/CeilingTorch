...
public class NethersDelightCompat implements ICeilingTorchCompat {
	//@formatter:off
	public static final RegistryObject<Block> CEILING_PROPELPLANT_TORCH = CeilingTorch.BLOCKS.register("nethersdelight_propelplant_torch", () -> new CeilingTorchBlock(BlockBehaviour.Properties.of()
