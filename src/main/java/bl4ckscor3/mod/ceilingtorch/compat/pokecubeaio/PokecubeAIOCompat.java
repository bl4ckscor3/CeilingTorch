...
public class PokecubeAIOCompat implements ICeilingTorchCompat
{
	...
	{
		event.getRegistry().register(ultraCeilingTorch = new UltraCeilingTorchBlock(Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F).lightValue(6)).setRegistryName(new ResourceLocation(CeilingTorch.MODID, "pokecube_legends_ultra_torch1")));
	}
