...
public class ChickenEggCeilingTorchBlock extends CeilingTorchBlock {
	...
	public ChickenEggCeilingTorchBlock(Properties properties) {
		super(properties, null, () -> ModBlocksRegisterFactory.CHICKEN_EGG_TORCH);
	...
	public void onPlace(BlockState state, Level world, BlockPos pos, BlockState oldState, boolean isMoving) {
		world.getCapability(ModCapabilitiesRegisterFactory.CHICKEN_EGG_SPAWNING).ifPresent(capability -> capability.addSpawnBlocker(spawnBlockerFactory.build(pos)));
	}
	...
	public void onRemove(BlockState state, Level world, BlockPos pos, BlockState newState, boolean isMoving) {
		...
		world.getCapability(ModCapabilitiesRegisterFactory.CHICKEN_EGG_SPAWNING).ifPresent(capability -> capability.removeSpawnBlocker(spawnBlockerFactory.build(pos)));
	}
}
