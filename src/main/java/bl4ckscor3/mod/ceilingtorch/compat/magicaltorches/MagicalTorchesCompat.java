...
public class MagicalTorchesCompat implements ICeilingTorchCompat
{
	...
	public void registerBlocks(RegistryEvent.Register<Block> event)
	{
		...
		event.getRegistry().register(chickenEggCeilingTorch = new ChickenEggCeilingTorchBlock(Block.Properties.create(Material.WOOD).hardnessAndResistance(3.0F).sound(SoundType.WOOD).doesNotBlockMovement().lightValue(15)).setRegistryName(new ResourceLocation(CeilingTorch.MODID, "magical_torches_chicken_egg_torch")));
	}
