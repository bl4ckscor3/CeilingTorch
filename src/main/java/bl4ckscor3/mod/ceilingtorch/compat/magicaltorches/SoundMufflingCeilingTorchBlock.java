...
public class SoundMufflingCeilingTorchBlock extends CeilingTorchBlock {
	...
	public void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean isMoving) {
		if (!level.isClientSide) {
			SoundMufflingCapability capability = level.getData(ModAttachments.SOUND_MUFFLING);
			capability.addSoundMuffler(level.dimension(), new SoundMufflingTorchSoundMuffler(pos));
		}
	}
	...
	public void onRemove(BlockState state, Level level, BlockPos pos, BlockState newState, boolean isMoving) {
		if (!level.isClientSide) {
			SoundMufflingCapability capability = level.getData(ModAttachments.SOUND_MUFFLING);
			capability.removeSoundMuffler(level.dimension(), new SoundMufflingTorchSoundMuffler(pos));
		}
