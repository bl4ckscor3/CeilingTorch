...
public class SoundMufflingCeilingTorchBlock extends CeilingTorchBlock {
	...
	public SoundMufflingCeilingTorchBlock(Properties properties) {
		super(properties, null, () -> ModBlocksRegisterFactory.SOUND_MUFFLING_TORCH);
	}
	...
	public void onPlace(BlockState state, Level world, BlockPos pos, BlockState oldState, boolean isMoving) {
		world.getCapability(ModCapabilitiesRegisterFactory.SOUND_MUFFLING).ifPresent(capability -> capability.addSoundMuffler(world.dimension(), new SoundMufflingTorchSoundMuffler(pos)));
	}

	@Override
	public void onRemove(BlockState state, Level world, BlockPos pos, BlockState newState, boolean isMoving) {
		world.getCapability(ModCapabilitiesRegisterFactory.SOUND_MUFFLING).ifPresent(capability -> capability.removeSoundMuffler(world.dimension(), new SoundMufflingTorchSoundMuffler(pos)));
