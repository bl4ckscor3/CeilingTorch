...
public class ColoredCeilingTorchBlock extends CeilingTorchBlock {
	...
	public ColoredCeilingTorchBlock(BlockBehaviour.Properties properties, DyeColor dyeColor, Supplier<Block> original) {
		super(properties, ParticleTypes.FLAME, original);
		color = ParticleColor.fromInt(dyeColor.getFireworkColor());
	}
