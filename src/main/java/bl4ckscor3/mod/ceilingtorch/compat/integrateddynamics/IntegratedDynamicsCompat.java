...
public class IntegratedDynamicsCompat implements ICeilingTorchCompat {
	...
	public static final DeferredBlock<Block> MENRIL_CEILING_TORCH = CeilingTorch.BLOCKS.register("integrateddynamics_menril_torch", () -> new MenrilCeilingTorchBlock(getProperties(SoundType.WOOD), ParticleTypes.FLAME, RegistryEntries.BLOCK_MENRIL_TORCH));
	public static final DeferredBlock<Block> MENRIL_CEILING_TORCH_STONE = CeilingTorch.BLOCKS.register("integrateddynamics_menril_torch_stone", () -> new MenrilCeilingTorchBlock(getProperties(SoundType.STONE), ParticleTypes.FLAME, RegistryEntries.BLOCK_MENRIL_TORCH_STONE));
	...
	public Map<ResourceLocation, Block> getPlaceEntries() {
		if (placeEntries == null) {
			//@formatter:off
			placeEntries = Map.of(MENRIL_TORCH_RL, MENRIL_CEILING_TORCH.get(),
