...
public class SecretRoomsCompat implements ICeilingTorchCompat
{
	...
	{
		event.getRegistry().register(ceilingTorchLever = new CeilingTorchLeverBlock(Block.Properties.create(Material.WOOD).lightValue(14)).setRegistryName("secretroomsmod_torch_lever"));
	}
