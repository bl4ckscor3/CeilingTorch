...
import bl4ckscor3.mod.ceilingtorch.compat.atum.AtumCompat;
...
public class CeilingTorch
{
	...
	public static final DeferredRegister<BlockEntityType<?>> TILE_ENTITIES = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, CeilingTorch.MODID);
	...
	public CeilingTorch()
	{
		...
		if(ModList.get().isLoaded("atum"))
			preliminaryCompatList.put("atum", AtumCompat::new);
		...
		if(ModList.get().isLoaded("endergetic"))
			preliminaryCompatList.put("endergetic", EndergeticCompat::new);
